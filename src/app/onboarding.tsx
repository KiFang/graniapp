...
export default function Onboarding() {
  ...
  const slides: Slide[] = [
    ...
    {
      title: 'Задания, Хочуметр, розыгрыши',
      text: [
        'Под кнопкой «Отметиться» — задания на день. Выполнил — жми «Забрать» и получай очки.',
        'На странице встречи есть Хочуметр: кинь «Хочу» в 1–3 игры, и самые желанные скорее возьмут с собой.',
        'В «Магазине» → «Розыгрыши» лидеры разыгрывают очки, титулы и настоящие призы. Итоги подводятся сами.',
      ],
      art: <StreakArt a={palette.accent} />,
      accent: palette.accent,
    },
